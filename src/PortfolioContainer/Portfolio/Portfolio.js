                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body bg-black">
                    ...
                    <div>
                      ...
                      <p>
                        {" "}
                        Features : In this project there are two sections one is
                        for users and another is for admin with login System via
                        firebase authentication . Users can comment, book orders
                        , cancel orders as well as pay money . Admin can add
                        products , delete products , manage orders , add admin
                        etc Technologies : React , React Router , React-Hooks
                        ,React-Query , Firebase , Tailwind ,
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body bg-black">
                    ...
                    <div>
                      Features : There is a login system implemented by firebase
                      authentication. one can add a new car, delete a car ,
                      modify information and for database management Mongodb
                      used with nodeJS. Showing details by clicking on a single
                      product Technologies : React ,React Router ,
                      React-Toostify , React-Hooks-Form , Bootstrap Firebase ,
                      Firebase-hooks , Nodejs , Express js , Mongodb
                    </div>
                  </div>
                  <div class="modal-footer">
                    <button
        ...
        <article className="portfolio_item">
          ...
          <div>
            ...
            <div
              ...
              id="exampleModalw"
              tabindex="-1"
              aria-labelledby="exampleModalLabelw"
              aria-hidden="true"
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelw">
                      Modal title
                    </h5>
                    <button
                      type="button"
                  ...
                  <div class="modal-body bg-black">
                    ...
                    <div>
                      <p>
                        Features : Implemented dynamic route and protecting
                        Implemented login system with firebase authentication
                        for google login and registration Technologies : React ,
                        React Bootstrap , React Router , Json-Api firebase
                        authentication , firebase-authentication-hooks
                      </p>
                    </div>
                  </div>
                  <div class="modal-footer">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body bg-black">
                    ...
                    <div>
                      ...
                      there are number of books are availabe . just select some
                      books and there name will be showon in rigt side . if
                      someone click in right side then automitically it will
                      choose one to you .
                    </div>
                  </div>
                  <div class="modal-footer">
          ...
          <div>
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelp">
                      Modal title
                    </h5>
                    <button
                      type="button"
                  ...
                  <div class="modal-body bg-black">
                    <p>
                      This is a web site where i implemented react , react
                      router , react rechart dash board , pie chart , bar-chart
                      etc .
                    </p>
                  </div>
                  <div class="modal-footer">
          ...
          <div className="container">
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelz">
                      Modal title
                    </h5>
                    <button
                      type="button"
                  ...
                  <div class="modal-body bg-black">
                    <p>
                      It is a website i have made it by using the Technologies
                      which is Bootstrap , and i deploy it in netlify , in this
                      website i have shown something like a ecomerece website
                    </p>
                  </div>
                  <div class="modal-footer">
                    <button
