    ...
    <section className="full-about-section" id="about">
      ...
      <div className="container about_container">
        ...
        <div className="about_content">
          ...
          <p>
            I am a Full Stack web developer . i learned html , css , bootstrap ,
            tailwind ,javascript , react , react-router , firebase , nodejs,
            mongodb , expressjs, github, heroku, netlify etc . I hava a huge
            passion to start my professional life as a full Stack-web Developer
            . I always try to learn new new technologies. Number of projects i
            have done with html-css, bootstrap , tailwind , react, javascript
            ,mongodb,nodejs as well as with responsieness. Now i am highly
            confident and dedicated to work with a company and team based . if i
            get any opurtunity i will to explore myself as much as
            possible.......
          </p>
          <div className="button-a">
            <a href="">
              <button className="  glow-on-hover">Lets Talk</button>
            </a>
          </div>
        </div>
      </div>
